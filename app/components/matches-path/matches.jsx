...
export default function Matches(p) {
  console.log(p);
  // const sm = JSON.parse(localStorage.getItem("Matches"));
        ...
        <div className="status">
          {allLength.length > 0 ? (
            <div
              ...
              onClick={() => {
                router.push(
                  `/matches/${moment(p.byDate).format("YYYY-MM-DD")}`
                );
              }}
              className="status-all-plus"
            >
          ...
          {live.length > 0 ? (
            <div
              ...
              onClick={() => {
                router.push(
                  `/status/live?date=${moment(p.byDate).format("YYYY-MM-DD")}`
                );
              }}
          ...
          {timed.length > 0 ? (
            <div
              ...
              onClick={() => {
                router.push(
                  `/status/timed?date=${moment(p.byDate).format("YYYY-MM-DD")}`
                );
              }}
          ...
          {finishLength.length > 0 ? (
            <div
              ...
              onClick={() => {
                router.push(
                  `/status/finish?date=${moment(p.byDate).format("YYYY-MM-DD")}`
                );
              }}
          ...
          {cancelLength.length > 0 ? (
            <div
              ...
              onClick={() => {
                router.push(
                  `/status/cancel?date=${moment(p.byDate).format("YYYY-MM-DD")}`
                );
              }}
