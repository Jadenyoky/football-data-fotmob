...
export default function Finish(p) {
  console.log(p);
  ...
  const apiMatches = async () => {
    ...
    setresults(finishLeagues);

    if (control.current.value !== "") {
      setls(
        finishLeagues.filter(
          (ele) =>
                          ...
                          .filter(
                            (ele) =>
                              ...
                              ele.away.name === "Israel U21"
                                ...
                                : ele) &&
                              ele.status.finished === true &&
                              ele.status.started === true &&
                              ele.status.cancelled === false
                          )
                          .map((e, k) => {
                            return (
                              <div key={k}>
        ...
        <div className="status">
          ...
          {finishLength.length > 0 ? (
            <div
              ...
              className="status-finished-plus"
            >
